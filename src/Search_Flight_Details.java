...
public class Search_Flight_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTprint.setRows(5);
        jTprint.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                jTprintAncestorAdded(evt);
            }
        ...
        jScrollPane2.setViewportView(jTprint);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nairobi", "Mombasa", "Kisumu", "Eldoret" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nairobi", "Mombasa", "Kisumu", "Eldoret" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(bticket, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(66, 66, 66)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
       ...
       try{
           pst=conn.prepareStatement(sql);
            pst.setString(1,source);
             ...
             Df.setRowCount(0);
             while(rs.next()){
                 //jTprint.setText(rs.getString("Flight_Name"));
    ...
    private void jTprintAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jTprintAncestorAdded
        // TODO add your handling code here:
        System.out.println("Name:" + tarea.getText());
        System.out.println("Seats" + seats.getName());
        System.out.println("Total price" + tprice.getText());
    }//GEN-LAST:event_jTprintAncestorAdded

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        jTprint.setText("Hello " + tarea.getText() + " \nyou are about to book a flight from\n " + source.getText() + " to \n" + dest.getText() + " worth " + tprice.getText());
